...
RUN test "$build" != "native-image" || ( \
  ...
  native-image $(curl -sL https://github.com/solsson/quarkus-graalvm-builds/raw/302596d2dc005a7c4b84e291d4c459772070a553/rest-json-quickstart.txt | sed 's/__APP__/backend-1.0-SNAPSHOT/g') \
)
